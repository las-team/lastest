...
function fallbackImage(message = "Lastest", accent = COLOR_INK): ImageResponse {
  return new ImageResponse(
    ...
    >
      ...
      <div
        style={{ marginTop: 24, fontSize: 28, color: accent, fontWeight: 600 }}
      >
        {message}
      </div>
    </div>,
              ...
              >
                ...
                <div
                  style={{
                    ...
                    top: 12,
                    backgroundColor:
                      hero?.kind === "diff" ? COLOR_RED : COLOR_INK,
                    color: "#FFFFFF",
                    fontSize: 14,
                    fontWeight: 800,
                    letterSpacing: 1.5,
