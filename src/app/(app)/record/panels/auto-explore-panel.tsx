      ...
      <div className="max-w-5xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Point the full agent pipeline at a URL. The Planner crawls routes
              and proposes functional areas; the Generator writes tests for each
              scenario; the Healer fixes failures. Progress streams to the
              activity feed.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Sets the repository&apos;s base URL and starts the Play Agent
                session.
              </p>
            </div>
