...
export function DiffViewerClient({ diff, buildId, prevDiffId, nextDiffId, banAiMode = false, initialFocusRegions = [], initialIgnoreRegions = [], allDiffs = [], textDiff = null }: DiffViewerClientProps) {
