    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              You will continue to receive transactional emails (password
              resets, security alerts, invitations) — those are required to
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Transactional emails (password resets, security alerts, invitations)
            will continue — they are required to operate your account.
          </p>
          <p className="text-sm text-muted-foreground">
