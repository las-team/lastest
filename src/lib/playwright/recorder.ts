...
export class PlaywrightRecorder extends EventEmitter {
  ...
  private async setupEventListeners(): Promise<void> {
    ...
    await this.page.exposeFunction('__recordAction', (action: string, selectors: ActionSelector[], value?: string, boundingBox?: { x: number; y: number; width: number; height: number }, actionId?: string, modifiers?: KeyboardModifier[]) => {
