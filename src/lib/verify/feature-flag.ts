...
export function isVerifyPhaseEnabled(team?: Pick<Team, 'verifyPhaseEnabled'> | null | undefined): boolean {
  if (process.env.VERIFY_PHASE_ENABLED === '1' || process.env.VERIFY_PHASE_ENABLED === 'true') {
    return true;
  }
