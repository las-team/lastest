...
export const TESTING_TEMPLATES: Record<
  Exclude<TestingTemplateId, "custom">,
  TestingTemplate
> = {
  saas: {
    name: "SaaS / Dashboard",
    description:
      "Data-heavy dashboards with dynamic content, timestamps, and charts",
  ...
  marketing: {
    ...
    description:
      "Static marketing pages with third-party scripts and hero images",
    icon: "Globe",
    settings: {
      browser: "chromium",
      headlessMode: "true",
  ...
  canvas: {
    name: "Canvas / Drawing",
    description:
      "WebGL, canvas-based, or drawing apps with rendering variability",
    icon: "Palette",
    settings: {
      browser: "chromium",
      headlessMode: "shell",
  ...
  ecommerce: {
    name: "E-commerce",
    description:
      "Product catalogs with prices, images, and dynamic cart content",
    icon: "ShoppingCart",
    settings: {
      browser: "chromium",
      headlessMode: "true",
  ...
  "mobile-first": {
    name: "Mobile-First",
    description:
      "Mobile viewport with touch interactions and responsive layouts",
    icon: "Smartphone",
    settings: {
      browser: "webkit",
      headlessMode: "true",
  ...
  cms: {
    name: "CMS",
    description:
      "Content management systems with rich editors, media, and loaders",
    icon: "FileEdit",
    settings: {
      browser: "chromium",
      headlessMode: "true",
