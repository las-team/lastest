...
// Paths
// ---------------------------------------------------------------------------
const SS = path.resolve(
  "storage/screenshots/c8fc9e1c-413d-4013-9920-cdbab5fe7f0c",
);
...
const PAIRS: ImagePair[] = [
  {
    ...
    baseline: path.join(
      SS,
      "02110815-d9f9-4b30-bb81-ccd8fba5ddbb-d9253cb7-a44e-418e-963a-c871a38e89bd.png",
    ),
    current: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-d9253cb7-a44e-418e-963a-c871a38e89bd.png",
    ),
  ...
  },
  {
    ...
    current: path.join(
      SS,
      "0ff4bddc-78a5-4edd-a813-97bd6033fca5-d9253cb7-a44e-418e-963a-c871a38e89bd.png",
    ),
  ...
  },
  {
    ...
    baseline: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-1296b7c5-1140-4629-8f8e-127421417465.png",
    ),
    current: path.join(
      SS,
      "3594ad16-8571-40cd-a7fa-91f4448944dd-1296b7c5-1140-4629-8f8e-127421417465.png",
    ),
  ...
  },
  {
    ...
    baseline: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-3179cc8b-5366-456f-8577-2729d960c391.png",
    ),
    current: path.join(
      SS,
      "3594ad16-8571-40cd-a7fa-91f4448944dd-3179cc8b-5366-456f-8577-2729d960c391.png",
    ),
  ...
  },
  {
    ...
    baseline: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-71e949dd-b794-4c1b-9d27-5777b918bd2c.png",
    ),
    current: path.join(
      SS,
      "3594ad16-8571-40cd-a7fa-91f4448944dd-71e949dd-b794-4c1b-9d27-5777b918bd2c.png",
    ),
  ...
  },
  {
    ...
    current: path.join(
      SS,
      "3594ad16-8571-40cd-a7fa-91f4448944dd-d9253cb7-a44e-418e-963a-c871a38e89bd.png",
    ),
  ...
  },
  {
    ...
    baseline: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-3bb40151-c9ac-4aa2-8080-6aaaee61f2f4.png",
    ),
    current: path.join(
      SS,
      "3594ad16-8571-40cd-a7fa-91f4448944dd-3bb40151-c9ac-4aa2-8080-6aaaee61f2f4.png",
    ),
  ...
  },
  {
    ...
    baseline: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-cac7b0bf-e98e-4c61-8d10-bb6116bb2fb6-mobile.png",
    ),
    current: path.join(
      SS,
      "04285d0d-7fd8-406d-937b-02405f421361-cac7b0bf-e98e-4c61-8d10-bb6116bb2fb6.png",
    ),
  ...
  },
  {
    ...
    current: path.join(
      SS,
      "f9d5471d-bacc-455a-913c-aca65efb2de2-cac7b0bf-e98e-4c61-8d10-bb6116bb2fb6-mobile.png",
    ),
  ...
  },
  {
    ...
    description:
      "Pre-aligned pair from storage/diffs — pure pixelmatch benchmark",
  },
];
  ...
  for (const el of elements) {
    ...
    for (let y = el.y; y < Math.min(el.y + el.rh, h); y++) {
      for (let x = margin; x < w - margin; x++) {
        const idx = (y * w + x) * 4;
        png.data[idx] = el.color[0];
        png.data[idx + 1] = el.color[1];
        png.data[idx + 2] = el.color[2];
        png.data[idx + 3] = el.color[3];
      }
    }
  }
  return png;
...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    current: () =>
      addSubPixelNoise(gradientPNG(W, H, 50, 50, 100, 200, 150, 50), 500, 42),
  },
  {
    name: "checkerboard-vs-shifted",
    description:
      "Checkerboard AA pattern shifted 1px (worst case for pixelmatch)",
    expectedDiff: "subtle",
    humanNoticeable: false,
  ...
  },
  {
    ...
    humanNoticeable: true,
    baseline: () =>
      rectPNG(W, H, { x: 50, y: 50, rw: 80, rh: 60 }, [0, 0, 0, 255]),
    current: () =>
      rectPNG(W, H, { x: 50, y: 50, rw: 80, rh: 60 }, [0, 0, 80, 255]),
  },
  {
    name: "rect-added",
    ...
    baseline: () => solidPNG(W, H, 255, 255, 255),
    current: () =>
      rectPNG(W, H, { x: 30, y: 30, rw: 120, rh: 80 }, [220, 50, 50, 255]),
  },
  {
    name: "rect-removed",
...
describe("Multi-Engine Accuracy Benchmark", () => {
  ...
  afterAll(() => {
    ...
    for (const name of scenarioNames) {
      ...
      console.log(
        `  Expected: ${scenario.expectedDiff} | Human noticeable: ${scenario.humanNoticeable ? "YES" : "no"}`,
      );
      console.table(
        rows.map((r) => ({
          Engine: r.engine,
    ...
    for (const engine of ENGINES) {
      const engineRows = ENGINE_RESULTS.filter(
        (r) => r.engine === engine && !r.error,
      );

      const tp = engineRows.filter(
        (r) => r.humanNoticeable && r.detectedDiff,
      ).length;
      const fn = engineRows.filter(
        (r) => r.humanNoticeable && !r.detectedDiff,
      ).length;
      const tn = engineRows.filter(
        (r) => !r.humanNoticeable && !r.detectedDiff,
      ).length;
      const fp = engineRows.filter(
        (r) => !r.humanNoticeable && r.detectedDiff,
      ).length;

      const sensitivity =
        tp + fn > 0 ? ((tp / (tp + fn)) * 100).toFixed(1) : "N/A";
      const specificity =
        tn + fp > 0 ? ((tn / (tn + fp)) * 100).toFixed(1) : "N/A";
      const precision =
        tp + fp > 0 ? ((tp / (tp + fp)) * 100).toFixed(1) : "N/A";
      const f1 =
        tp + fp > 0 && tp + fn > 0
      ...
      const avgTime =
        engineRows.length > 0
          ? Math.round(
              engineRows.reduce((s, r) => s + r.durationMs, 0) /
                engineRows.length,
            )
          : 0;
    ...
    for (const scenario of SCENARIOS) {
      const pm = ENGINE_RESULTS.find(
        (r) => r.scenario === scenario.name && r.engine === "pixelmatch",
      );
      const ss = ENGINE_RESULTS.find(
        (r) => r.scenario === scenario.name && r.engine === "ssim",
      );
      const bt = ENGINE_RESULTS.find(
        (r) => r.scenario === scenario.name && r.engine === "butteraugli",
      );
    ...
    for (const engine of ENGINES) {
      const rows = ENGINE_RESULTS.filter(
        (r) => r.engine === engine && !r.error,
      );
      if (rows.length === 0) {
      ...
      console.log(
        `  ${engine}: avg=${avg}ms, p50=${p50}ms, min=${min}ms, max=${max}ms`,
      );
    }
    ...
    // Clean up
    try {
      fs.rmSync(ENGINE_TEMP_DIR, { recursive: true, force: true });
    } catch {
      /* ignore */
    }
  });
