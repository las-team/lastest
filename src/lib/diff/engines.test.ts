...
describe("Diff Engines", () => {
  ...
  describe("pixelmatch", () => {
    ...
    it("threshold sensitivity — strict detects more", () => {
      ...
      expect(strict.diffPixelCount).toBeGreaterThanOrEqual(
        lenient.diffPixelCount,
      );
    });
  });
  ...
  describe("ssim", () => {
    ...
    it("is more tolerant of subtle changes than pixelmatch", () => {
      ...
      expect(ssimResult.diffPixelCount).toBeLessThanOrEqual(
        pmResult.diffPixelCount,
      );
    });
  });
