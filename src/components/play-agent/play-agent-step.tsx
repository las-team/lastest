...
const AGENT_BADGE_STYLES: Record<
  PwAgentType,
...
export function PlayAgentStep({
  ...
  const isReviewWaiting =
    step.id === "review" && step.status === "waiting_user";
