...
export function SetupGuide({ initialStatus, latestBuildId }: SetupGuideProps) {
  ...
  const steps: StepDefinition[] = [
    { label: 'Connect GitHub', description: 'Link your GitHub account to sync repositories', actionLabel: 'Connect GitHub', href: '/settings?highlight=github' },
    { label: 'Configure AI', description: 'Set up AI provider for test generation', actionLabel: 'Configure AI', href: '/settings?highlight=ai-settings' },
    { label: 'Scan Routes', description: 'Discover routes in your repository', actionLabel: 'Go to Tests', href: '/tests' },
