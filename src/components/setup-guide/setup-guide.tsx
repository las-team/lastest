...
export function SetupGuide({ initialStatus, latestBuildId }: SetupGuideProps) {
  ...
  const steps: StepDefinition[] = [
    ...
    {
      label: "Configure AI",
      description: "Set up AI provider for test generation",
      actionLabel: "Configure AI",
      href: "/settings?highlight=ai-settings",
    },
    {
      label: "Scan Routes",
      description: "Discover routes in your repository",
      actionLabel: "Go to Tests",
      href: "/tests",
    },
    {
      label: "Record a Test",
      description: "Create your first visual regression test",
      actionLabel: "Record Test",
      href: "/record",
    },
    {
      label: "Run Tests",
      description: "Execute all tests to capture screenshots",
      actionLabel: "Run All",
    ...
    {
      label: "Run Again",
      description: "Make changes to your app and run tests again",
      actionLabel: "Run All",
      onClick: handleRunBuild,
    },
    {
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <Progress
          ...
          aria-label={`Getting started progress: ${progress}%`}
        />
      </CardHeader>
