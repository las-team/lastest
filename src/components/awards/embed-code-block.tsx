...
export function EmbedCodeBlock({ code, label }: { code: string; label?: string }) {
  ...
  return (
    <div className="relative w-full">
      ...
      <pre
        className="m-0 rounded-sm bg-muted text-foreground/90 px-3 py-2 font-mono text-[11px] leading-relaxed whitespace-pre-wrap break-all overflow-hidden border border-border/60"
      >
        {code}
      </pre>
      <button
