...
export function QuickstartEmailTemplateInput({ initial }: QuickstartEmailTemplateInputProps) {
  ...
  return (
    <div className="space-y-1.5">
      <span className="text-sm font-medium">QuickStart demo email template</span>
      <p className="text-xs text-muted-foreground/70">
        Used by the QuickStart agent when registering demo users. Must contain
        <code className="mx-1">{'{slug}'}</code> and
        <code className="mx-1">{'{stamp}'}</code> tokens (e.g. <code>viktor+&#123;slug&#125;&#123;stamp&#125;@lastest.cloud</code>).
      </p>
