...
export function MCPExploreRoutesDialog({
  ...
  const [step, setStep] = useState<
    "input" | "exploring" | "preview" | "generate"
  >("input");
    ...
    <Dialog open={open} onOpenChange={(newOpen) => !newOpen && handleClose()}>
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === "input" &&
              "Enter the base URL of your running application to discover routes by browsing it."}
            {step === "exploring" &&
              "AI is browsing your application to discover routes..."}
            {step === "preview" &&
          ...
          <div className="flex flex-col gap-4 py-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                Make sure your application is running at this URL before
                starting.
              </p>
            </div>
          </div>
