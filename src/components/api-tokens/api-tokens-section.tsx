...
export function ApiTokensSection({
  ...
  const handleRevoke = async (id: string) => {
    if (
      !confirm("Revoke this API key? Any clients using it will stop working.")
    )
      return;
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            For the MCP server, VS Code extension, and custom scripts.
          </p>
        </div>
        <Dialog
          open={open}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-md p-3 text-sm">
                  ...
                  <p className="text-muted-foreground">
                    This key authenticates as your user against the Lastest API.
                    Store it securely and revoke it from this page if
                    compromised.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    A name to recognize this key later.
                  </p>
                </div>
      ...
      {tokens.length === 0 ? (
        <div className="text-center py-6 text-muted-foreground border rounded-md">
          ...
          <p className="text-xs">
            Create one to connect the MCP server or VS Code extension.
          </p>
        </div>
      ) : (
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {" · "}
                  {t.lastUsedAt
                    ? `last used ${formatDistanceToNow(t.lastUsedAt, { addSuffix: true })}`
                    : "never used"}
                </p>
              </div>
              <Button
