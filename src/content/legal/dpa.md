...
DEXILION SZOLGÁLTATÓ KORLÁTOLT FELELŐSSÉGŰ TÁRSASÁG has established these definitions to improve understanding of the scope of this document:

"DEXILION", "We" or "Our": refers to DEXILION SZOLGÁLTATÓ KORLÁTOLT FELELŐSSÉGŰ TÁRSASÁG as a service provider of the Open Source design and prototyping platform, LASTEST (the "Services").

"You" or "Client": refers to the individual, agent or other entity that requests the DEXILION Services.
...
"Data Processor" or "Processor": Shall have the same meaning as in the GDPR, i.e. the party who carries out the processing of data on behalf of and in representation of a Data Controller. DEXILION is the Data Processor of the users' data associated to the Data Controller.

"Party": Shall mean DEXILION and/or the Client, according to the context.

"Personnel": Shall refer to persons and/or consultants engaged by DEXILION or by the Client as employees or independent contractors, as appropriate, and to provide services to any of the Parties involved. In some cases, these personnel may also fall into the category of data subjects, as their personal data may be shared between the Parties or with the Client's end users.
...
The term of this DPA will be that of the main agreement which describes the contracted services. The cancellation, termination or extinction of the contractual relationship for the provision of services between the Client and DEXILION will entail the deletion of the personal data and the removal of any copies in DEXILION's possession.

DEXILION, hereby informs you that in cases where the Controller terminates and/or interrupts its relationship with DEXILION, the procedure for the suppression and, where appropriate, blocking of the information may take up to ninety (90) days depending on the cause for which the relationship between the Parties has ended or been interrupted.
...
This obligation is of a generic nature and applies generally to data and information provided within the DEXILION's Services provision to the Client.
...
In the processing of personal data, DEXILION, as Data Processor, undertakes to ensure and protect the public freedoms and fundamental rights of individuals and, in particular, their honor and their personal and domestic privacy.

DEXILION will cooperate with the Data Controller in order to comply with the data subjects' data protection rights requests and shall inform them that they may exercise their rights of access, erasure, rectification, opposition, restriction of processing and/or portability by means of a letter addressed to the Data Controller at the postal address and/or e-mail address that may be applicable in each case.

Should a Data Subject exercise any of the rights set out in the preceding paragraph directly before DEXILION, it undertakes to forward the request to the Data Controller within a maximum of ten (10) business days upon receipt of the request.
...
DEXILION informs you that no international data transfers are foreseen for the provision of the above-mentioned Services.
