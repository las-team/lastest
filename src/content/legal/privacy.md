...
Dexilion SZOLGÁLTATÓ KORLÁTOLT FELELŐSSÉGŰ TÁRSASÁG (Tax ID: HU32698031 Kisgömb utca 17, Budapest, Hungary, H-1135, email: privacy@lastest.cloud) is the data controller for the personal information processed through our websites and services.
...
This policy applies to personal information processed by Dexilion across our websites (e.g. lastest.cloud, and any other domains we own or operate), mobile applications, and related services (collectively, the "Services").
...
In order to ensure that the information provided is always up to date and free of errors, you must notify Dexilion as soon as possible of any changes to your personal data by sending an e-mail to the e-mail address: privacy@lastest.cloud
...
3. ### **Information from Third Parties & Social Logins**

If you log in via a social media platform, we may receive profile information (name, email, avatar) subject to your platform's privacy settings.

4. ### **Sensitive Personal Information**

We do not process sensitive personal information (e.g., racial/ethnic origin, political opinions, health data, biometrics, sexual orientation).

3. ## **Source of the data**

We consider that all the data processed by Dexilion has been provided to us freely.

In the event that the personal data provided is from a third person, you guarantee that you have informed them of this Privacy Policy and have obtained their authorisation to provide the data to Dexilion for the purposes indicated above. You also guarantee that the information provided is accurate and up to date, and you are responsible for any direct or indirect damage or harm that may be caused as a result of non-compliance with this obligation.
...
**Marketing Opt-Out**: Unsubscribe via the link in any marketing email, or contact us directly. Service-related communications (security, account updates, legal notices) will continue.

**Account Termination**: You may update or delete your account at any time through your dashboard. Upon deletion, we will deactivate your account and remove active data, retaining only what is legally required.

8. ## **Retention periods and Cookies.**

We will only keep your data for as long as the commercial relationship is maintained, your account exists or its elimination is not requested by the data subject. Any of the data you provide us through the channels will be held as long as they are no longer necessary to manage the service and will only be available if there is a legal obligation (derived from a request from the appropriate authorities) and when you exercise your rights.

Regarding the personal data obtained through the potential candidates, for a reasonable period of time not exceeding 2 years to handle any questions related to the application, to contact them regarding other employment opportunities and for legitimate business interests.

Regarding the personal data obtained through the Dexilion channels, Dexilion uses Cookies according to the Cookies Policy.
...
10. ## **Email Domains Used for Communication**
...
The Services are not directed to individuals under 18. In this regard, and to the extent that Dexilion is not able to control whether or not users are minors, it shall be the parents and guardians who shall enable the necessary mechanisms to prevent minors from accessing the Website and/or providing personal data, and Dexilion shall not accept any liability in this regard.

12. ## **Specific privacy rights of United States residents**
