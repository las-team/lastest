import type { QaPageSnapshot } from "@lastest/eb-protocol";
 ...
 * `./page.ts` — the plugin never connects to a browser itself and never sees a
 * pod address), renders the target URL, extracts a
 ...
 */
export function attachPageObservers(page: QaPage, baseOrigin: string) {
