...
import { ConfigList } from "./gitlab/config-list-client";
import { AddConfigDialog } from "./gitlab/add-config-dialog-client";
...
/**
 * `connectAccountButton` was `<ConnectGitlabButton />`, an app component that
 * starts the OAuth flow. Recipe §6 — see the GitHub card for the reasoning.
 */
    ...
    <Card id="gitlab-pipelines">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="space-y-1">
          ...
          <CardDescription>
            Auto-run visual tests on branches and merge requests — including
          ...
          <div className="rounded-md border border-amber-500/50 bg-amber-500/5 p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">
                Connect a GitLab account (gitlab.com or self-hosted) to add
                pipeline configs.
              </p>
            </div>
            {connectAccountButton}
