 ...
 *
 * NOTE: Only works in the local runner (requires fs access to public/fonts/).
 * Remote/embedded runners receive the pre-computed CSS via the stabilization payload.
 */
