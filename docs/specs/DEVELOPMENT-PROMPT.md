...
**Core Diffing (high value):** 2. Multi-Engine Diffing (#1) 3. Text-Region-Aware Diffing (#2) 4. Diff Benchmark Framework (#6)

**Workflow:** 5. Async Background Jobs (#4) 6. AI Prompt Improvements (#5)
